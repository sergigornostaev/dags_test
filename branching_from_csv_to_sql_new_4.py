...
def check_file_exists():
    ...
    file_path = os.path.expanduser('~/datasets_from_net/for_datalens.csv') #'~/datasets_from_net/for_datalens.csv' #  
...
def my_python_function():
    ...
    df.to_csv(os.path.expanduser('~/datasets_from_net/for_datalens_processed.csv'))
...
with DAG(
    dag_id="simple_sql_python_bash_dag_with_conditioning_new_4",
